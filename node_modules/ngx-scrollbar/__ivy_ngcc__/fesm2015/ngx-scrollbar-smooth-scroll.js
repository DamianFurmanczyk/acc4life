...
SmoothScrollManager = __decorate([ __param(0, Inject(DOCUMENT)),
...
SmoothScroll.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: SmoothScroll, selectors: [["", "smoothScroll", ""], ["", "smooth-scroll", ""]], exportAs: ["smoothScroll"] });
SmoothScroll.ctorParameters = () => [
    { type: ElementRef },
    { type: SmoothScrollManager }
];
SmoothScroll = __decorate([ __metadata("design:paramtypes", [ElementRef, SmoothScrollManager])
], SmoothScroll);

let SmoothScrollModule = class SmoothScrollModule {
};
SmoothScrollModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: SmoothScrollModule });
SmoothScrollModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function SmoothScrollModule_Factory(t) { return new (t || SmoothScrollModule)(); } });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(SmoothScrollManager, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(SmoothScroll, [{
        type: Directive,
        args: [{
